 ...
 * @version $Id: JdbcMutableAclService.java 2142 2007-09-21 18:18:21Z luke_t $
 */
public class PostgresqlJdbcMutableAclService extends PostgresqlJdbcAclService implements MutableAclService {
    //~ Instance fields ================================================================================================
    ...
    private String identityQuery = "SELECT currval(pg_get_serial_sequence('acl_sid', 'id'))";
    private String classIdentityQuery = "SELECT currval(pg_get_serial_sequence('acl_class', 'id'))";
    private String insertClass = "INSERT INTO acl_class (id, class) VALUES (DEFAULT, ?)";
    private String insertEntry = "INSERT INTO acl_entry "
        + "(id, acl_object_identity, ace_order, sid, mask, granting, audit_success, audit_failure)"
        + "VALUES (DEFAULT, ?, ?, ?, ?, ?, ?, ?)";
    private String insertObjectIdentity = "INSERT INTO acl_object_identity "
        + "(id, object_id_class, object_id_identity, owner_sid, entries_inheriting) " + "VALUES (DEFAULT, ?, ?, ?, ?)";
    private String insertSid = "INSERT INTO acl_sid (id, principal, sid) VALUES (DEFAULT, ?, ?)";
    ...
    public PostgresqlJdbcMutableAclService(DataSource dataSource, LookupStrategy lookupStrategy, AclCache aclCache) {
